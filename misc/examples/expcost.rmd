...
library(lubridate)
metricData = data.table(with(avocadoData$data, data.frame(time=ymd_hms(AnalysisDate),metric=Metric, exp=TAvg, expCount=TN,  holdout=CAvg, holdoutCount=CN, delta=Delta, sd=Delta_SE, pdelta=PercentDelta, psd=PercentDelta_SE,stringsAsFactors=FALSE)))
...
Write helper function for visualization with ggplot
